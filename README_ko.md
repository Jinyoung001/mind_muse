...
교육학 연구가 이를 뒷받침합니다: *프로테제 효과(Protégé Effect)* — 누군가에게 가르칠 것을 예상할 때 나타나는 측정 가능한 학습 향상 — 에 따르면, 학습을 가르침으로 설정하면 수동적 학습보다 더 깊은 처리, 더 강한 기억 부호화, 더 나은 장기 기억을 활성화합니다. Nestojko et al. (2014)는 결정적인 뉘앙스를 밝혔습니다: 효과는 학습 **전에** 가르칠 것이라고 예상할 때 극대화됩니다 — 학습 *후에* 가르치라고 지시하면 효과가 거의 사라집니다. MIND MUSE는 이 기대를 첫 탭부터 설계에 내장합니다: 학생이 이미지에 드로잉하는 순간, 외계인이 오해할 것이고 설명해야 한다는 걸 이미 압니다. 대화가 시작되기 전에 '가르치는 태도'가 먼저 활성화됩니다.

이 효과는 청자의 능력과 무관합니다 — *Betty's Brain* 연구에서 학생들이 가상의 AI 에이전트에게 가르쳤을 때도 동등한 효과가 나타났으며, 메커니즘이 청자가 아닌 학생 내부에 있음을 확인했습니다. AI 기반 파인만 봇에 관한 독립 연구(arXiv, 2025)에서도 이와 유사한 'AI에게 가르치기' 방식이 수동적 학습 그룹보다 학습 성과와 자신감 모두에서 높은 결과를 보였습니다.
